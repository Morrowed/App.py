...
p1_dob = st.sidebar.date_input("Partner 1 Birthdate", today)
p1_retire_date = st.sidebar.date_input("Partner 1 Target Retirement Date", today)
...
p2_dob = st.sidebar.date_input("Partner 2 Birthdate", today)
p2_retire_date = st.sidebar.date_input("Partner 2 Target Retirement Date", today)
